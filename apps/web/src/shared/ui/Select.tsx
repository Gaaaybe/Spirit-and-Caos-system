...
export function Select({ 
  ...
  const baseClasses = "w-full px-3 py-2 border rounded-md transition-colors focus:outline-none focus:ring-2 focus:ring-offset-1 bg-white dark:bg-gray-800 dark:text-gray-100";
